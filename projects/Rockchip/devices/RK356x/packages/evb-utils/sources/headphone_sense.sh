...
/usr/bin/evb_utils.sh setaudio $(get_ee_setting "audio.device")
/usr/bin/evb_utils.sh vol $(get_ee_setting "audio.volume")
/usr/bin/evb_utils.sh bright $(get_ee_setting "brightness.level")
fi
